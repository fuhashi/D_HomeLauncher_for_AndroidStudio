...
//    final float RESIZE_THRESHOLD = 0.66f;
    final float RESIZE_THRESHOLD = 0.6f;
    ...
    public void snapToWidget(boolean animate) {
        ...
        if (!animate) {
            ...
            ObjectAnimator oa =
                    ViewAnimUtils.ofPropertyValuesHolder(lp, this, width, height, x, y);
            ObjectAnimator leftOa = ViewAnimUtils.ofFloat(mLeftHandle, "alpha", 1.0f);
            ObjectAnimator rightOa = ViewAnimUtils.ofFloat(mRightHandle, "alpha", 1.0f);
            ObjectAnimator topOa = ViewAnimUtils.ofFloat(mTopHandle, "alpha", 1.0f);
            ObjectAnimator bottomOa = ViewAnimUtils.ofFloat(mBottomHandle, "alpha", 1.0f);
            oa.addUpdateListener(new AnimatorUpdateListener() {
                public void onAnimationUpdate(ValueAnimator animation) {
                    requestLayout();
                }
            });
            AnimatorSet set = ViewAnimUtils.createAnimatorSet();
