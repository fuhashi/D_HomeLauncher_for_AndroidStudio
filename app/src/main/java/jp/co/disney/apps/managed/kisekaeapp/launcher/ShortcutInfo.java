...
class ShortcutInfo extends ItemInfo {
    ...
    ShortcutInfo() {
        ...
        spanX = Workspace.ICON_SPAN;
        spanY = Workspace.ICON_SPAN;
        minSpanX = spanX;
        minSpanY = spanY;
    }
    ...
    void onAddToDatabase(ContentValues values) {
        ...
        values.put(LauncherSettings.Favorites.SHORTCUT_NAME, shortcutName);
    }
    ...
    public static void dumpShortcutInfoList(String tag, String label,
        ...
        for (ShortcutInfo info: list) {
            DebugLog.instance.outputLog(tag, "   title=\"" + info.title + " icon=" + info.mIcon
                    + " customIcon=" + info.customIcon);
        }
    }
}
