...
package jp.co.disney.apps.managed.kisekaeapp.system.view.animation;
...
public class FirstFrameAnimatorHelper extends AnimatorListenerAdapter
    ...
    private static ViewTreeObserver.OnPreDrawListener sGlobalPreDrawListener;
        ...
        sGlobalDrawListener = new ViewTreeObserver.OnDrawListener() {
                ...
                public void onDraw() {
                    ...
                    if (DEBUG) {
                        ...
                        DebugLog.instance.outputLog("FirstFrameAnimatorHelper", "TICK " + (newTime - mTime));
                        mTime = newTime;
                    }
                }
            };
    ...
    public static void initializePreDrawListener(View view) {
        if (sGlobalPreDrawListener != null) {
            view.getViewTreeObserver().removeOnPreDrawListener(sGlobalPreDrawListener);
        }
        sGlobalPreDrawListener = new ViewTreeObserver.OnPreDrawListener() {
                private long mTime = System.currentTimeMillis();
        ...
        view.getViewTreeObserver().addOnPreDrawListener(sGlobalPreDrawListener);
        sVisible = true;
    }
    ...
    public void print(ValueAnimator animation) {
        ...
        DebugLog.instance.outputLog("FirstFrameAnimatorHelper", sGlobalFrameCounter +
