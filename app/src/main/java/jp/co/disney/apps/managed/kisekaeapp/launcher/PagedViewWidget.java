...
public class PagedViewWidget extends LinearLayout {
    ...
    public void applyFromAppWidgetProviderInfo(AppWidgetProviderInfo info,
            int maxWidth, int[] cellSpan, WidgetPreviewLoader loader, Integer themeTextColor) {
        mIsAppWidget = true;
        mInfo = info;
        final ImageView image = (ImageView) findViewById(R.id.widget_preview);
        if (maxWidth > -1) {
        ...
        if (themeTextColor != null) {
            name.setTextColor(themeTextColor);
        }
        ...
        if (dims != null) {
            ...
            if (ThemeUtils.isDisneyWindow5xWidget(info.provider.getClassName())) {
                hSpan = 10;
            }
            dims.setText(String.format(mDimensionsFormatString, hSpan / 2, vSpan / 2));
            if (themeTextColor != null) {
                dims.setTextColor(themeTextColor);
            }
        }
    ...
    public void applyFromResolveInfo(
            PackageManager pm, ResolveInfo info, WidgetPreviewLoader loader, Integer themeTextColor) {
        mIsAppWidget = false;
        mInfo = info;
