...
public class ShortcutAndWidgetContainer extends ViewGroup {
    ...
    public void setCellDimensions(float cellWidth, float cellHeight, int countX) {
    ...
    public void setupLp(CellLayout.LayoutParams lp) {
        lp.setup(mCellWidth, mCellHeight, mCountX);
    }
    ...
    public void measureChild(View child) {
        ...
        lp.setup(cellWidth, cellHeight, mCountX);
