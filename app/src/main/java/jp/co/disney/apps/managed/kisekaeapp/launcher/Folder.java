...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    protected FolderCellLayout mContent;
    ...
    public void animateOpen() {
        ...
        final ObjectAnimator oa =
            ViewAnimUtils.ofPropertyValuesHolder(this, alpha, scaleX, scaleY);
    ...
    protected boolean createAndAddShortcut(ShortcutInfo item) {
        ...
        textView.applyFromShortcutInfo(item, mIconCache, mContent.getCellWidth(), mContent.getIconSize(),
                mContent.getCellPaddingTop(), mContent.getTextPadding(), LauncherApplication.getScreenDensity());

        textView.setTextColor(ContextCompat.getColor(getContext(), R.color.folder_icon_text_color));
    ...
    private void replaceFolderWithFinalItem() {
            ...
            public void run() {
               ...
               View child = null;
                ...
                if (getItemCount() == 1) {
                    ...
                    finalItem.minSpanX = finalItem.spanX = Workspace.ICON_SPAN;
                    finalItem.minSpanY = finalItem.spanY = Workspace.ICON_SPAN;
        ...
        if (finalChild != null) {
            CellLayout cellLayout = mLauncher.getCellLayout(mInfo.container, mInfo.screen);
            mFolderIcon.performDestroyAnimation(finalChild, onCompleteRunnable, cellLayout.getIconSize(), cellLayout.getCellPaddingTop());
        }
        mDestroyed = true;
    }
