...
public class InstallWidgetReceiver {
    public static final String ACTION_INSTALL_WIDGET =
            "jp.co.disney.apps.managed.kisekaeapp.action.INSTALL_WIDGET";
    public static final String ACTION_SUPPORTS_CLIPDATA_MIMETYPE =
            "jp.co.disney.apps.managed.kisekaeapp.action.SUPPORTS_CLIPDATA_MIMETYPE";
    ...
    public static final String EXTRA_APPWIDGET_COMPONENT =
        "jp.co.disney.apps.managed.kisekaeapp.extra.widget.COMPONENT";
    public static final String EXTRA_APPWIDGET_CONFIGURATION_DATA_MIME_TYPE =
        "jp.co.disney.apps.managed.kisekaeapp.extra.widget.CONFIGURATION_DATA_MIME_TYPE";
    public static final String EXTRA_APPWIDGET_CONFIGURATION_DATA =
        "jp.co.disney.apps.managed.kisekaeapp.extra.widget.CONFIGURATION_DATA";
